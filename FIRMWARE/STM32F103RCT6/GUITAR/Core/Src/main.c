...
uint32_t Bai1[500] = {
  ...
  0b00111110000000100010010000000000,
  0b00011111000000000000001100000010,
  0b00001111000000001000000100000010,
  0b00011100000000010000001000000000,
  0b00000100000000000000000000000000,
  0b00000001000000000000000000000000,
  0b00000001000000000000000000000000,
  0b00000001000000000000000000000000,
  0b00000010000000000000000000000010,
  0b00101110000000100000000000000000,
  ...
  0b00000010000000000000000000000000,
  0b00000010000000000000000000000000,
  0b00010110000000000000000010000000,
  0b00000100000000000000000100000000,
  0b00000010000000000000000000000010,
  0b00000010000000000000000000000010,
  0b00000010000000000000000000000010,
  0b00000100000000000000000000000000,
  0b00001100000000001000000100000000,
  0b00000010000000000000000000000010,
  ...
  0b00000010000000000010000000000000,
  0b00000010000000000000000000000010,
  0b00010110000000010000000000000010,
  0b00001000000000000000001000000000,
  0b00000100000000000000000000000000,
  0b00000001000000000000000000000000,
  0b00000001000000000000000000000000,
  0b00000001000000000000000000000000,
  ...
  0b00000010000000000010000000000000,
  0b00000010000000000010000000000000,
  0b00010011000000000000000000000010,
  ...
  0b00000010000000000000000000000010,
  0b00000100000000000000000000000000,
  0b00001000000000001000000000000000,
  0b00000100000000000000000100000000,
  0b00000001000000000000000000000000,
  0b00000010000000000010000000000000,
  0b00000010000000000010000000000000,
  0b00000010000000000000000000000010,
  0b00011110000000010000001000000010,
  ...
  0b00001000000000000000001000000000,
  0b00001000000000000000000000000000,
  0b00101000000000100000000000000000,
  ...
  0b00001000000000000000000000000000,
  0b00010000000000010000000000000000,
  0b00101000000000000000001000100000,
  0b00001000000000001000000000000000,
  0b00001000000000000000001000000000,
  0b00001000000000000000001000000000,
  ...
  0b00000100000000000000000000000000,
  0b00000100000000000000000100000000,
  0b00101000100000000000001000000000,
  0b00001000000000000000000000000000,
  0b00010000000000010000000000000000
};
...
int main(void)
{
  ...
  // for(uint8_t j =0; j < sizeof(Bai1); j++)
  // {
  //   uint32_t bitt = Bai1[j];
  //   for(uint8_t u = 0; u < 25; u = u+ 8)
  //   {
  //     HAL_UART_Transmit(&huart3, (uint8_t*)((bitt >> u)), sizeof((bitt >> u)), 100);
  //   }
  // }
  /* USER CODE END 2 */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
    for(uint8_t i = 0; i < sizeof(Bai1); i++)
    {
      uint32_t bit = Bai1[i];
